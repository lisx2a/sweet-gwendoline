					...
					<br />
							...
							<div class="product"><a href="waspwaist.php">
												<img src="images/wasp-waist-karen.jpg" width="177px" /><div class="view" style="position:absolute;margin-top:120px;margin-left:9px;height:25px;width:159px;background:url(images/sg_buttons.png) no-repeat 0 -170px"></div></a>
														...
														<div class="details" style="margin-top:230px;position:absolute;"><p>Wasp Waist<br />$28.00<br /></p></div>
							</div>
							...
							<div class="product ">
										<a href="butterfly-heels.php"><img src="images/butterfly-in-heels-karen.jpg" style="width:177px;" /><div class="view" style="position:absolute;margin-top :120px;margin-left:9px;height:25px;width:159px;background:url(images/sg_buttons.png) no-repeat 0 -170px"></div></a>
											...
											<p class="details"style="margin-top:230px;position:absolute;">Butterfly in Heels<br />$33.00</p>
							</div>
							...
							<div class="product"><a href="about-this-tank.php">
											...
											<p class="details"style="margin-top:230px;position:absolute;">About These Corsets<br />$40.00<br /></p>
							</div>
							...
							<div class="product-last"><a href="star-bizarre.php">
												...
												<p class="details"style="margin-top:230px;position:absolute;">Star Bizarre<br />$28.00<br /></p>
							</div>
							...
							<div class="product captionfull"><a href="crawl.php">
												...
												<p class="details"style="margin-top:230px;position:absolute;">Crawl<br />$28.00<br /></p>
							</div>
							...
							<div class="product captionfull"><a href="pretty-polly.php">
													...
													<p class="details"style="margin-top:230px;position:absolute;">Pretty Polly<br />$28.00<br /></p>
							</div>
							...
							<div class="product captionfull"><a href="tamed.php">
											...
											<p class="details"style="margin-top:230px;position:absolute;">Tamed<br />$33.00<br /></p>
							</div>
							...
							<div class="product-last"><a href="plead.php">
											...
											<p class="details"style="margin-top:230px;position:absolute;">Plead<br />$28.00<br /></p>
							...
							<div class="product captionfull"><a href="mistress.php">
											...
											<p class="details"style="margin-top:230px;position:absolute;">Mistress<br />$33.00<br /></p>
							</div>
							...
							<div class="product captionfull"><a href="corset-boy.php">
											...
											<p class="details"style="margin-top:230px;position:absolute;">Corseted Boy Beater<br />$48.00<br /></p>
							</div>
							...
							<div class="product-last"><a href="wench-boy.php">
											...
											<p class="details"style="margin-top:230px;position:absolute;">Wench Boy Beater<br />$48.00<br /></p>
							</div>
							...
							<div class="product captionfull"><a href="teacup.php">
												...
												<p class="details"style="margin-top:230px;position:absolute;">Tied Up for Tea<br />$20.00<br /></p>
